...
export default function GaugeComponent({
    ...
    return (
        <motion.div
            ...
            className="relative p-8 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-white/20 hover:bg-white/[0.07] transition-all duration-300"
        >
            ...
            <div className="relative z-10 flex flex-col items-center gap-6">
                ...
                <div className="relative w-48 h-48">
                    <svg className="w-full h-full transform -rotate-90" viewBox="0 0 200 200">
                        <circle cx="100" cy="100" r="90" fill="none" stroke="#1a2a3a" strokeWidth="2" opacity="0.3" />
                        <motion.circle
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                        {grossValue !== undefined ? (
                            <>
                                <div className="text-center">
                                    <p className="text-xs text-zinc-500 font-mono mb-1">GROSS</p>
                                ...
                                <div className="text-center">
                                    <p className="text-xs text-zinc-500 font-mono mb-1">NET</p>
